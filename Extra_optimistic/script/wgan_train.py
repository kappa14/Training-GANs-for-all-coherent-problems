...
import numpy as np, sys, argparse, pickle
...
if __name__ == '__main__':
    ...
    #print("Pass1")
    system('cp /content/gdrive/MyDrive/optimistic_GAN_training-master/Extra_optimistic/script/models.py' + ' '+ outdir)
    #print("Pass2")
    ...
    for epoch in range(epochs):
        ...
        print('{0:<22s} | {1:4s} '.format('component', '{}'.format(discriminator_model.metrics_names)))
        print('-' * 65)
        ...
        if((epoch+1) % 5 == 0):
            ...
            # Dump history
            pickle.dump({'train': train_history, 'test': test_history}, open(join(outdir,'history.pkl'), 'wb'))
